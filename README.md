...
I am running this in WSL and I am using uv, so there will be a few changes.

####

First, and most obviously, install uv if you have not (might require sudo) and set up/update your virtual environment.
...
Next, you must have chromedriver installed
